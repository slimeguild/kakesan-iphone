...
static NSString* const kKSTitle = @"×3";
...
static NSString* const kMyEventTitle = @"マイイベント";
static NSString* const kCreateEventTitle = @"イベント作成";
...
static NSString* const kSessionCheckPath = @"/sessions/check";
static NSString* const kIndexEventPath = @"/events";
static NSString* const kMyEventPath = @"/private/events";
static NSString* const kCreateEventPath = @"/events/new";
